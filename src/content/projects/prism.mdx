...
cover:
  image: "/images/prism/prism-variety-medium.avif"
...
<DefaultLayout 
  ...
  ogImage="/images/open-graph/project-prism.jpg"
  preloadMPlus300
>
  ...
  <div class="container mx-auto">
    ...
    <ClassicCarouselBlock 
      project={'prism'} 
      slides={[
        { url: "/images/prism/prism-variety-large.avif" },
        { url: "/images/prism/prism-tiled-hex-large.avif" },
        { url: "/images/prism/prism-internals-large.avif" },
        { url: "/images/prism/prism-tiled-grid-large.avif" },
      ]} 
      links={[
    ...
    <Center class="px-6">
      <DefaultMarkdownRenderer>
        ...
        <ClassicImageTextBlock src="/images/prism/prism-tiled-hex-medium.avif">
        ...
        <ClassicImageTextBlock src="/images/prism/prism-internals-medium.avif">
          ### An Elegant Solution
    ...
    <ClassicSpecsTable 
      headerImageSrc='/images/prism/prism-dimensions-medium.jpg' 
      specs={[
