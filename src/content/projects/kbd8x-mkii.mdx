...
coverImage:
  url: "/assets/projects/kbd8x-mkii/img_0002_largesize.avif"
...
<DefaultLayout title={frontmatter.title}>
  ...
  <div class="container mx-auto">
    ...
    <div class="text-center pt-20 px-6">
      <DefaultMarkdownRenderer>
        ### A Lasting Legacy
        The KBD8X MKII served as an always-accessible, premium yet affordable TKL for years until it was superceded by a MKIII design created by another designer.  
        Its highly-rated design would serve as a starting point for developing the [Polaris](/projects/polaris), which would eventually turn into the Reference series of designs.  
