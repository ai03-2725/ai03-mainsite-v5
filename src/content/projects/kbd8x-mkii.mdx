...
cover:
  image: "/images/kbd8x-mkii/kbd8x-mkii-render-front-blue-medium.avif"
...
<DefaultLayout 
  ...
  ogImage="/images/open-graph/project-kbd8x-mkii.jpg"
  preloadMPlus300
>

  <div class="w-full h-[350px] overflow-hidden">
    <img src="/images/kbd8x-mkii/kbd8x-mkii-render-variety-medium.avif" alt="Cover banner" class="object-cover w-full h-full" />
  </div>

  <div class="text-center pt-20 pb-24 px-6">
    <h1 class="!font-['M_PLUS_Rounded_1c'] font-[300] !text-[42px] !md:text-[52px] lg:!text-[60px]">KBD8X MKII</h1>
  ...
  <HorizontalStackBlock
    src="/images/kbd8x-mkii/kbd8x-mkii-render-front-blue-medium.avif" 
    alt="Top render"
    bgColor='E2F6F5'
  >
    ### Minimal and elegant
  ...
  <HorizontalStackBlock
    src="/images/kbd8x-mkii/kbd8x-mkii-render-variety-bottom-medium.avif"
    alt="Bottom renders"
    bgColor='CEF0DF'
    reverse
  >
  ...
  <HorizontalStackBlock
    src="/images/kbd8x-mkii/kbd8x-mkii-render-exploded-front-medium.avif" 
    alt="Exploded view"
    bgColor='A7DCD4'
  >
    ### An eye on internals
  ...
  <HorizontalStackBlock
    src="/images/kbd8x-mkii/kbd8x-mkii-render-pcb-medium.avif"
    alt="PCB render"
    bgColor='B9EBF1'
    reverse
  >
  ...
  <HorizontalStackBlock
    src="/images/kbd8x-mkii/kbd8x-mkii-render-with-kbdpad-mkii-medium.avif" 
    alt="Numpad view"
    bgColor='9BC5D3'
  >
    ### A perfect pair
  ...
  <div class="container mx-auto">
    ...
    <ClassicSpecsTable 
      headerImageSrc='/images/kbd8x-mkii/kbd8x-mkii-dimensions-medium.avif' 
      specs={[
        ["Case Weight", "2370g",],
...
Case options: Full or WKL top`,],
        ["Layouts", "![Layout diagram](/images/kbd8x-mkii/kbd8x-mkii-layouts-diagram-medium.avif)",],        
    ]} />
