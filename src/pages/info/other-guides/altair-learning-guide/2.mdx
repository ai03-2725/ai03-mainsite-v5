...
>
  ...
  <AltMarkdownRenderer>
    ...
    First, place the two halves of your Altair at a slight outwards angle.  
    ...
    Place one of your hands over the Altair with fingers uncurled, with the fingers roughly parallel with the columns.  
    ...
    <SimpleButtonV2 href="/info/other-guides/altair-learning-guide/3/">The Daily-Use Bar</SimpleButtonV2>
