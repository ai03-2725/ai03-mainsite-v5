...
>
  ...
  <AltMarkdownRenderer>
    <SimpleImageV2 src="/images/altair/altair-render-4row-keyset-01-medium.avif" class="w-full mx-auto" />
    ...
    <SimpleButtonV2 href="/info/other-guides/altair-x-learning-guide/2/">The Basics</SimpleButtonV2>
