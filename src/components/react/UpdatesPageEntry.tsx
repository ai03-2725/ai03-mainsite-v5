...
import type { MinimumProjectsIndex } from './UpdatesPage';
              ...
              {data.length > 0 ?
                <div class="flex flex-col h-full">
                  ...
                  <div class="flex flex-col items-start gap-2">
                    ...
                    {data.length > 1 ?
                      <button 
                        class={`py-2 px-4 bg-zinc-700 text-white rounded-[3.75px]`}
                    ...
                    :
                      <button
                        class={`py-2 px-4 bg-zinc-500 text-white rounded-[3.75px]`}
                        disabled
                      >
                        All Updates Shown
                      </button>
